...
# Fixed placeholder values — Angel One validates format not actual values
_LOCAL_IP  = "192.168.1.1"
_PUBLIC_IP = "106.193.147.98"
_MAC_ADDR  = "20:E6:17:07:19:3F"


def _auth_headers(api_key: str) -> dict:
    """Headers for login endpoint."""
    return {
...
async def angel_generate_token(
    ...
    async with httpx.AsyncClient(headers=_auth_headers(api_key), timeout=TIMEOUT) as c:
        resp = await c.post(
